...
# Comme enonce dans la presentation des donnees kaggle: le test set est apres le 2018-12-1 jusqu'au 2019-01-31
...
#Ces dernieres colonnes remplit de na gene la regression : keyword, isTrueDirect, referralPath, bounces
#Les temps et la memoire demande nous oblige a reduire les sets
library(dplyr)
train = sample_n(train,50000)
val = sample_n(val,50000)


# Observation des correlations pour les colonnes numeriques: "visitId", "visitNumber", visitStartTime" "visits" "hits" "pageviews" "bounces" "newVisits" 
...
# l'erreur a legerement augmente: 2.26428e+14 cela ne change quasiment rien
# Axe d'amelioration : en rajoutant des features (mois et jour)
